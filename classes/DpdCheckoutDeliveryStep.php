...
class DpdCheckoutDeliveryStep extends CheckoutDeliveryStep
{
    ...
    public function render(array $extraParams = array())
    {
        ...
        $templates .= $this->renderTemplate(_PS_MODULE_DIR_ . 'dpdconnect' . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . '8' . DIRECTORY_SEPARATOR . '_dpdLocator8.tpl');
